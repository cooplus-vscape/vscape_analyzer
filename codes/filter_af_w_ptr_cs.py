...
deletecollection(COOPPLUSDB, VMETHOD_TO_AN+"_af_w_ptrcs")
vmcl, vmclient = getdbhandler(COOPPLUSDB, VMETHOD_TO_AN+"_af_w_ptrcs")
cl, clclient = getdbhandler(COOPPLUSDB, CLASSLAYOUTRAW)

# deletecollection(COOPPLUSDB, VCALLSITE+"_af_w_ptrcs")
