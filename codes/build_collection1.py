...
def generate_structure_layouts_collection(databasecl):
...
#     parser.add_argument('-sc', '--save-collection', action='store_true',
#                         help='Check commutativity conditions for sat/unsat')
#     parser.add_argument('-lc', '--load-collection', action='store_true',
#                         help='Check commutativity conditions for sat/unsat')

#     parser.add_argument('-gc', '--generate-collection', action='store_true',
#                         help='Check commutativity conditions for sat/unsat')
#     parser.add_argument('-gvf', '--generate-virtualfunction', action='store_true',
#                         help='Check commutativity conditions for sat/unsat')
#     parser.add_argument('-svf', '--save-virtualfunctions', action='store_true',
#                         help='Check commutativity conditions for sat/unsat')
#     parser.add_argument('-lvf', '--load-virtualfunctions', action='store_true',
#                         help='Check commutativity conditions for sat/unsat')
#     parser.add_argument('-gpott', '--generate-pottdata', action='store_true',
#                         help='Check commutativity conditions for sat/unsat')

# # parser.add_argument('-t', '--test-file',
# #                     help='Test generator output file')
#     parser.add_argument("-fs", "--filter_strategy",
#                         default="filter_simple", help='Module to test (e.g., models.fs)')
#     # parser.add_argument()
#     args = parser.parse_args()
    ...
    # import IPython
    # IPython.embed()
    deletecollection(COOPPLUSDB,CLASSLAYOUT)
    databasecl,client = getdbhandler(COOPPLUSDB,CLASSLAYOUT)

    generate_structure_layouts_collection(databasecl)
